...
class Model:
    ...
    def predict_from_image(self, image_file, class_indices = None):
        '''
        ...
        if self.model_type == 'keras':
            ...
            if class_indices:
                ...
                return class_label.get(class_idx, "Unknown class")
            return class_idx
            ...
            img_array = img_array.asttype(input_details[0]['dtype'])
            ...
            if class_indices:
                ...
                return class_labels.get(class_idx, "Unknown class")
            return class_idx
